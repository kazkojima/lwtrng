...
from litedram.modules import MT41K256M16, MT41K64M16
...
from lwtrng.phy import LwTrngECP5PHYBitGen
from lwtrng.rng import LwTrngGenerator32
...
class BaseSoC(SoCCore):
    def __init__(self, revision="1.0", device="85F", sdram_size="8Gbit", sys_clk_freq=int(60e6), toolchain="trellis",
        ...
        **kwargs)       :
        ...
        if not self.integrated_main_ram_size:
            ...
            sdram = MT41K64M16 if (sdram_size == "2Gbit") else MT41K256M16
            self.add_sdram("sdram",
                phy           = self.ddrphy,
                module        = sdram(sys_clk_freq, "1:2"),
...
def main():
    ...
    parser.add_argument("--sdram-size",      default="8Gbit",        help="SDRAM size (default: 8Gbit)")
    ...
    # ECP5 TRNG requires --ignore-loops option for nextpnr because of ring
    # oscillator.
    args.nextpnr_ignoreloops = True
